...
// COMPATIBILITY mbed <-> SDK BLUENRG1
#define WWDG_IRQn		WDG_IRQn	/*!< Window WatchDog Interrupt	*/
#define FLASH_IRQn		NVM_IRQn	/*!< FLASH global Interrupt		*/
#define ADC1_IRQn		ADC_IRQn	/*!< ADC1 Interrupt				*/
#define SPI1_IRQn		SPI_IRQn    /*!< SPI1 global Interrupt		*/
#define USART1_IRQn 	UART_IRQn   /*!< USART1 global Interrupt	*/
#define GPIO_TypeDef	GPIO_Type
#define GPIOA_BASE		GPIO_BASE
#define GPIOB_BASE		GPIO_BASE
